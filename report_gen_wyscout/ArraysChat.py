...
def extract_arrays_wyscout2(wyscout_file,parameters_file,player_id_analizing,param_entry,min_minutes):
    ...
    if "Vencimiento contrato" not in df_stats.columns:
        df_stats["Vencimiento contrato"] = None

    df_general_stats=df_stats[["Jugador","Equipo","Equipo durante el período seleccionado","Edad",market_value_col,"Vencimiento contrato","Partidos jugados","Minutos jugados","player_id",'general_position', 'general_position2',"general_position3"]].copy()
