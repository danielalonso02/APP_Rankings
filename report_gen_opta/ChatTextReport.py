...
from report_gen_opta.ArraysChat import extract_arrays_wyscout2
...
def chat(question, context, action, language=None, chat_log=None):
    ...
    if action == 'rewrite':
        ...
        action_message=f"Rewrite and translate this football-context message into {language}, using coherent, detailed, and professional football technical language and include the values provided. Act as an experienced football scout agent. Provide ONLY a DAFO (SWOT) analysis of the player/team/idea described and . Do not include any additional commentary or quotes.  Limit the response to 200 words. For bold letter weight use <b> and </b> instead of ** **"
