...
def extract_arrays_wyscout(wyscout_file,parameters_file,player_id1,player_id2,param_entry,min_minutes):
    ...
    stats_player1=df_stats[df_stats["player_id"]==player_id1].iloc[0]
    player_position1=general_stats_player1["general_position"]
    
    #jugador 2
    general_stats_player2=df_general_stats[df_general_stats["player_id"]==player_id2].iloc[0]

    stats_player2=df_stats[df_stats["player_id"]==player_id2].iloc[0]
    player_position2=general_stats_player2["general_position"]
    ...
    if common_ordered_unique:
        player_position=common_ordered_unique[0]
        
    else:
        print("No tienen la misma posición")
        return None, None, None, None, None, None, None, None, None
    ...
    df_stats_percentile1=df_stats_percentile[df_stats_percentile["player_id"]==player_id1]
    df_stats_percentile2=df_stats_percentile[df_stats_percentile["player_id"]==player_id2]
    ####
    param_of1_id=[]
    param_of2_id=[]
    ...
    if param_entry=="param_of1":
        ...
        player_array1=stats_player1[param_ofensive1]
        player_array2=stats_player2[param_ofensive1]
        params_array=param_ofensive1
        percentiles_player1=df_stats_percentile1[param_ofensive1].values.flatten().tolist()
        percentiles_player2=df_stats_percentile2[param_ofensive1].values.flatten().tolist()
        ...
        player_array1=stats_player1[param_ofensive2]
        player_array2=stats_player2[param_ofensive2]
        params_array=param_ofensive2
        percentiles_player1=df_stats_percentile1[param_ofensive2].values.flatten().tolist()
        percentiles_player2=df_stats_percentile2[param_ofensive2].values.flatten().tolist()
        ...
        player_array1=stats_player1[param_defensive]
        player_array2=stats_player2[param_defensive]
        params_array=param_defensive
        percentiles_player1=df_stats_percentile1[param_defensive].values.flatten().tolist()
        percentiles_player2=df_stats_percentile2[param_defensive].values.flatten().tolist()
        ...
        player_array2=None
        params_array=None
        percentiles_player1=None
        percentiles_player2=None
        param_en=None
    
    
    return min_array,max_array,player_array1,player_array2,params_array, df_stats,percentiles_player1,percentiles_player2,param_en


# min_of2, max_of2, player_of21,player_of22, param_of2, df_all ,percentiles_of2,paramof2_en= extract_arrays_wyscout(
#     "/Users/julieta/Desktop/WYSCOUT/datoswyscout/espana_1_2025_2025_03_03.xlsx","/Users/julieta/Desktop/Parameters/parameters_en.xlsx",
#     39,42,
#     "param_of2",500
# )

def extract_arrays_wyscout_notas(wyscout_file,parameters_file,player_id_analizing,param_entry,min_minutes):
