...
def pizzaplot_player(filepath_excel,file_parameters,player_id_analizing,min_minutos,position_number,color="#34495E",league="Liga F",season="2024/25"):
    print("⚙️ Generando imagenes.")
    """
    ...
    fig3.subplots_adjust(top=0.95, bottom=0.18)
    baker_def = PyPizza(
...
if __name__ == "__main__":
    ...
    pizzaplot_player(
        ...
        filepath_excel=args.wyscout_file,
