...
#player_of_score,player_of_letter,player_def_score,player_def_letter,player_full_score,player_full_letter,number_of_players_position,Rank_of,Rank_def,Rank_full=notas_tacticas("Lateral","LigaF_wyscout_2025.xlsx","parameters.xlsx",40,100)
